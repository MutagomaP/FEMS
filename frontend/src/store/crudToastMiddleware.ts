...
const SUCCESS_MESSAGES: Partial<Record<string, string>> = {
  ...
  [createRenewal.fulfilled.type]: 'Renewal request submitted successfully',
  [approveRenewal.fulfilled.type]: 'Renewal request approved successfully',
  [rejectRenewal.fulfilled.type]: 'Renewal request rejected successfully',
  [completeRenewal.fulfilled.type]: 'Renewal completed successfully',
...
crudToastListener.startListening({
  matcher: isAnyOf(
    ...
    createRenewal.fulfilled,
    approveRenewal.fulfilled,
    rejectRenewal.fulfilled,
    completeRenewal.fulfilled,
